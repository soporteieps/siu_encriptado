...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIU_____form_sec_users"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIU_____form_sec_users"]);
   }
   ...
   unset($_SESSION['sc_session'][$script_case_init]['form_sec_users']['sc_redir_atualiz']);
   unset($_SESSION['sc_session'][$script_case_init]['form_sec_users']['sc_redir_insert']);
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_sec_users']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['form_sec_users']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_sec_users']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['form_sec_users']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['form_sec_users']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['form_sec_users']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['form_sec_users']['db_changed'])
           {
