...
$old_error_handler = set_error_handler("control_usuarios_scriptcase_error_handler");

function control_usuarios_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['control_usuarios']['contr_erro']) && $_SESSION['scriptcase']['control_usuarios']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_usuarios->contr_control_usuarios->Apl_com_erro = true;
            if ($inicial_control_usuarios->contr_control_usuarios->NM_ajax_flag)
            {
                $inicial_control_usuarios->contr_control_usuarios->NM_ajax_info['errList']['geral_control_usuarios'][] = $msg;
                return;
            }
            control_usuarios_scriptcase_error_display($msg, $err_no);
        }
...
function control_usuarios_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_usuarios'])  && '' != $_SESSION['scriptcase']['error_icon']['control_usuarios'])  ? $_SESSION['scriptcase']['error_icon']['control_usuarios']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_usuarios']) && '' != $_SESSION['scriptcase']['error_span_title']['control_usuarios']) ? $_SESSION['scriptcase']['error_span_title']['control_usuarios'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_usuarios']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_usuarios']) ? $_SESSION['scriptcase']['error_icon_title']['control_usuarios'] : '';
?>
