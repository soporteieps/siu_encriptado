...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_titl'] . " - "); } else { echo strip_tags("S.I.U. (Sistema de Inscripción Universal)"); } ?></TITLE>
...
<?php
include_once("control_usuarios_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('control_usuarios_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['recarga'];
}
?>
...
<?php
 include_once("control_usuarios_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['control_usuarios'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_usuarios'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['mostra_cab'] != "N"))
  {
?>
<tr><td>
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR align="center" valign="middle">
        <TD align="left" rowspan="2" class="scFormHeaderFont">
          <IMG SRC="<?php echo $this->Ini->path_imag_cab ?>/sys__NM__ieps_logo.png" BORDER="0"/>
        </TD>
       ...
       <TR align="right" valign="middle">
        <TD class="scFormHeaderFont">
          <?php echo "<b><h2>S.I.U. (Sistema de Inscripción Universal)</h2></b>" ?>
        </TD>
       </TR>
      </TABLE>
     </TD>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['login'] = "Usuario:";
    }
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_login" style="<?php echo $sStyleHidden_login; ?>;"><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['php_cmp_required']['login']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['php_cmp_required']['login'] == "on") { ?><span class="scFormRequiredOdd">*</span> <?php }?> <span id="id_label_login"><?php echo $this->nm_new_label['login']; ?></span></TD>
...
<span id="id_read_on_login" class="sc-ui-readonly-login" style=";<?php echo $sStyleReadLab_login; ?>"><?php echo NM_encode_input($this->login); ?></span><span id="id_read_off_login" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 size=30 maxlength=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['pswd'] = "Contraseña:";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_pswd" style="<?php echo $sStyleHidden_pswd; ?>;"><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_usuarios']['php_cmp_required']['pswd'] == "on") { ?><span class="scFormRequiredOdd">*</span> <?php }?> <span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span></TD>
...
<span id="id_read_on_pswd" class="sc-ui-readonly-pswd" style=";<?php echo $sStyleReadLab_pswd; ?>"><?php echo NM_encode_input($this->pswd); ?></span><span id="id_read_off_pswd" style="white-space: nowrap;<?php echo $sStyleReadInp_pswd; ?>"><input class="sc-js-input scFormObjectOdd" style=";" id="id_sc_field_pswd" type=password name="pswd" value="" 
 size=30 maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', enterTab: false, enterSubmit: true, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}"></span><?php } ?>
</TD>
   <?php }?>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bok", "nm_atualiza('alterar'); return false;", "nm_atualiza('alterar'); return false;", "sub_form_b", "", "Ingresar", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "");?>
...
{
?>
<script>parent.scAjaxDetailStatus("control_usuarios");</script>
<?php
}
?>
<?php
