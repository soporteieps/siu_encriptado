  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_usuarios" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate login
  function do_ajax_control_usuarios_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_usuarios_validate_login(var_login, var_script_case_init, do_ajax_control_usuarios_validate_login_cb);
  } // do_ajax_control_usuarios_validate_login

  function do_ajax_control_usuarios_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_usuarios_validate_login_cb

  // ---------- Validate pswd
  function do_ajax_control_usuarios_validate_pswd()
  {
    var nomeCampo_pswd = "pswd";
    var var_pswd = scAjaxGetFieldText(nomeCampo_pswd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_usuarios_validate_pswd(var_pswd, var_script_case_init, do_ajax_control_usuarios_validate_pswd_cb);
  } // do_ajax_control_usuarios_validate_pswd

  function do_ajax_control_usuarios_validate_pswd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pswd";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_usuarios_validate_pswd_cb
  // ---------- Form
  function do_ajax_control_usuarios_submit_form()
  {
    scAjaxHideMessage();
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_control_usuarios_submit_form(var_login, var_pswd, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_control_usuarios_submit_form_cb);
  } // do_ajax_control_usuarios_submit_form

  function do_ajax_control_usuarios_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_control_usuarios_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_control_usuarios_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_usuarios_navigate_form

  function do_ajax_control_usuarios_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sc_mupload_ok = true;
...
{
?>
    do_ajax_control_usuarios_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_usuarios_navigate_form_cb
