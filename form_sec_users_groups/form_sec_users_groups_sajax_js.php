  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sec_users_groups" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate login
  function do_ajax_form_sec_users_groups_validate_login()
  {
    var nomeCampo_login = "login";
    var var_login = scAjaxGetFieldText(nomeCampo_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sec_users_groups_validate_login(var_login, var_script_case_init, do_ajax_form_sec_users_groups_validate_login_cb);
  } // do_ajax_form_sec_users_groups_validate_login

  function do_ajax_form_sec_users_groups_validate_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sec_users_groups_validate_login_cb

  // ---------- Validate usuario
  function do_ajax_form_sec_users_groups_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldSelect(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sec_users_groups_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_sec_users_groups_validate_usuario_cb);
  } // do_ajax_form_sec_users_groups_validate_usuario

  function do_ajax_form_sec_users_groups_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "usuario";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sec_users_groups_validate_usuario_cb

  // ---------- Validate group_id
  function do_ajax_form_sec_users_groups_validate_group_id()
  {
    var nomeCampo_group_id = "group_id";
    var var_group_id = scAjaxGetFieldSelect(nomeCampo_group_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sec_users_groups_validate_group_id(var_group_id, var_script_case_init, do_ajax_form_sec_users_groups_validate_group_id_cb);
  } // do_ajax_form_sec_users_groups_validate_group_id

  function do_ajax_form_sec_users_groups_validate_group_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "group_id";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sec_users_groups_validate_group_id_cb

  // ---------- Event onchange usuario
  function do_ajax_form_sec_users_groups_event_usuario_onchange()
  {
    var var_login = scAjaxGetFieldText("login");
    var var_usuario = scAjaxGetFieldSelect("usuario");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sec_users_groups_event_usuario_onchange(var_login, var_usuario, var_script_case_init, do_ajax_form_sec_users_groups_event_usuario_onchange_cb);
  } // do_ajax_form_sec_users_groups_event_usuario_onchange

  function do_ajax_form_sec_users_groups_event_usuario_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "usuario";
    ...
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_sec_users_groups_event_usuario_onchange_cb
  // ---------- Form
  function do_ajax_form_sec_users_groups_submit_form()
  {
    scAjaxHideMessage();
    var var_login = scAjaxGetFieldText("login");
    var var_usuario = scAjaxGetFieldSelect("usuario");
    var var_group_id = scAjaxGetFieldSelect("group_id");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sec_users_groups_submit_form(var_login, var_usuario, var_group_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_form_sec_users_groups_submit_form_cb);
  } // do_ajax_form_sec_users_groups_submit_form

  function do_ajax_form_sec_users_groups_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("group_id");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_sec_users_groups_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_sec_users_groups_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sec_users_groups_navigate_form(var_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_script_case_init, do_ajax_form_sec_users_groups_navigate_form_cb);
  } // do_ajax_form_sec_users_groups_navigate_form

  function do_ajax_form_sec_users_groups_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_sec_users_groups_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sec_users_groups_navigate_form_cb
  ...
  ajax_field_list[2] = "group_id";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "login": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_users_groups_fld_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario": {"label": "Usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "group_id": {"label": "Perfil", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["group_id"][1] = "group_id";
  ...
  var ajax_field_id = {
    ...
    "group_id": new Array("hidden_field_label_group_id", "hidden_field_data_group_id")
  };
