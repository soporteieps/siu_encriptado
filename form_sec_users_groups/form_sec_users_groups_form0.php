...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Asignar Perfil de Usuario"); } else { echo strip_tags("Editar Perfil de Usuario"); } ?></TITLE>
...
<?php
include_once("form_sec_users_groups_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_sec_users_groups_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['recarga'];
}
?>
...
<?php
 include_once("form_sec_users_groups_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['form_sec_users_groups'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_sec_users_groups'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Asignar Perfil de Usuario"; } else { echo "Editar Perfil de Usuario"; } ?></span></td>
...
<tr><td>
<?php
if ((!$this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] != "R")
{
?>
...
if ((!$this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['fast_search'][2] : "";
?> 
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call)) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ($bTestReadOnly && ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || (isset($this->nmgp_cmp_readonly["login"]) &&  $this->nmgp_cmp_readonly["login"] == "on")) { 
 ...
 ?>
<input type=hidden name="login" value="<?php echo NM_encode_input($login) . "\"><span id=\"id_ajax_label_login\">" . $login . "</span>"; ?>
<?php } else { ?>
...
<input type=hidden name="usuario" value="<?php echo NM_encode_input($this->usuario) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_usuario" style="<?php echo $sStyleHidden_usuario; ?>;"><span id="id_label_usuario"><?php echo $this->nm_new_label['usuario']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['php_cmp_required']['usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['php_cmp_required']['usuario'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
?>
<input type=hidden name="usuario" value="<?php echo NM_encode_input($usuario) . "\">" . $usuario_look . ""; ?>
<?php } else { ?>
...
select login,login from sec_users where login not in (select login from sec_users_groups)";
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_usuario\" style=\";" .  $sStyleReadLab_usuario . "\">" . NM_encode_input($usuario_look) . "</span><span id=\"id_read_off_usuario\" style=\"" . $sStyleReadInp_usuario . "\">";
   echo " <span id=\"idAjaxSelect_usuario\"><select class=\"sc-js-input scFormObjectOdd\" style=\";\" id=\"id_sc_field_usuario\" name=\"usuario\" size=1>" ; 
   echo "\r" ; 
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
   if (!isset($this->nm_new_label['group_id']))
   {
       $this->nm_new_label['group_id'] = "Perfil";
   }
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $group_id = $this->group_id;
   $sStyleHidden_group_id = '';
   if (isset($this->nmgp_cmp_hidden['group_id']) && $this->nmgp_cmp_hidden['group_id'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['group_id']);
       $sStyleHidden_group_id = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_group_id = 'display: none;';
   $sStyleReadInp_group_id = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['group_id']) && $this->nmgp_cmp_readonly['group_id'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['group_id']);
       $sStyleReadLab_group_id = '';
       $sStyleReadInp_group_id = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['group_id']) && $this->nmgp_cmp_hidden['group_id'] == 'off') { $sc_hidden_yes++; ?>
<input type=hidden name="group_id" value="<?php echo NM_encode_input($this->group_id) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix" id="hidden_field_label_group_id" style="<?php echo $sStyleHidden_group_id; ?>;"><span id="id_label_group_id"><?php echo $this->nm_new_label['group_id']; ?></span></TD>
    <TD class="scFormDataOdd" id="hidden_field_data_group_id" style="<?php echo $sStyleHidden_group_id; ?>;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd" style=";;vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["group_id"]) &&  $this->nmgp_cmp_readonly["group_id"] == "on") { 
...
select group_id, description from sec_groups where status = 1";
   ...
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->group_id_1))
          {
              foreach ($this->group_id_1 as $tmp_group_id)
              {
                  if (trim($tmp_group_id) === trim($cadaselect[1])) { $group_id_look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->group_id) === trim($cadaselect[1])) { $group_id_look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type=hidden name="group_id" value="<?php echo NM_encode_input($group_id) . "\">" . $group_id_look . ""; ?>
<?php } else { ?>
...
select group_id, description from sec_groups where status = 1";
   ...
   $x = 0; 
   echo "<span id=\"id_read_on_group_id\" style=\";" .  $sStyleReadLab_group_id . "\">" . NM_encode_input($group_id_look) . "</span><span id=\"id_read_off_group_id\" style=\"" . $sStyleReadInp_group_id . "\">";
   echo " <span id=\"idAjaxSelect_group_id\"><select class=\"sc-js-input scFormObjectOdd\" style=\";\" id=\"id_sc_field_group_id\" name=\"group_id\" size=1>" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->group_id) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
...
?> 
<?php  }?>
</td></tr><tr><td style="vertical-align: top; padding: 1px 0px 0px 0px"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_group_id_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_group_id_text"></span></td></tr></table></td></tr></table></TD>
   <?php }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] != "F") { ?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['total'] + 1)?>);</script><?php } ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_sec_users_groups']['mostra_cab'] != "N"))
  {
...
{
?>
<script>parent.scAjaxDetailStatus("form_sec_users_groups");</script>
<?php
}
?>
<?php
