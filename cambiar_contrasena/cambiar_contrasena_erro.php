...
$old_error_handler = set_error_handler("cambiar_contrasena_scriptcase_error_handler");

function cambiar_contrasena_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['cambiar_contrasena']['contr_erro']) && $_SESSION['scriptcase']['cambiar_contrasena']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_cambiar_contrasena->contr_cambiar_contrasena->Apl_com_erro = true;
            if ($inicial_cambiar_contrasena->contr_cambiar_contrasena->NM_ajax_flag)
            {
                $inicial_cambiar_contrasena->contr_cambiar_contrasena->NM_ajax_info['errList']['geral_cambiar_contrasena'][] = $msg;
                return;
            }
            cambiar_contrasena_scriptcase_error_display($msg, $err_no);
        }
...
function cambiar_contrasena_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['cambiar_contrasena'])  && '' != $_SESSION['scriptcase']['error_icon']['cambiar_contrasena'])  ? $_SESSION['scriptcase']['error_icon']['cambiar_contrasena']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['cambiar_contrasena']) && '' != $_SESSION['scriptcase']['error_close']['cambiar_contrasena']) ? $_SESSION['scriptcase']['error_close']['cambiar_contrasena'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['cambiar_contrasena']) && '' != $_SESSION['scriptcase']['error_span_title']['cambiar_contrasena']) ? $_SESSION['scriptcase']['error_span_title']['cambiar_contrasena'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['cambiar_contrasena']) && '' != $_SESSION['scriptcase']['error_icon_title']['cambiar_contrasena']) ? $_SESSION['scriptcase']['error_icon_title']['cambiar_contrasena'] : '';
?>
