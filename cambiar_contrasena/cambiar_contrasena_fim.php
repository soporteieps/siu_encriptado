...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIU_____cambiar_contrasena"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIU_____cambiar_contrasena"]);
   }
   ...
   unset($_SESSION['sc_session'][$script_case_init]['cambiar_contrasena']['sc_redir_atualiz']);
   unset($_SESSION['sc_session'][$script_case_init]['cambiar_contrasena']['sc_redir_insert']);
   $fecha_janela = false;
   ...
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['cambiar_contrasena']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['cambiar_contrasena']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['cambiar_contrasena']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['cambiar_contrasena']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['cambiar_contrasena']['db_changed'])
           {
