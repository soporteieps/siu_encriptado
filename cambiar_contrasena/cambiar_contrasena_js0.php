...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['cambiar_contrasena']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
{
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?btnSalir?@?";
    document.F1.action = "cambiar_contrasena.php";
...
function NM_critica (form, campo, label, mask, tipo, intr, dec, min, max)
{
 ...
 NM_tab_crit[1] = new NM_critica('F1', 'old_pswd', 'Contraseña Actual', 'naomask', 'lista', 'cxab', 32, 'TUDO');
 NM_tab_crit[2] = new NM_critica('F1', 'pswd', 'Nueva Contraseña', 'naomask', 'lista', 'cxab', 32, 'TUDO');
 NM_tab_crit[3] = new NM_critica('F1', 'confirm_pswd', 'Repita Contraseña', 'naomask', 'lista', 'cxab', 32, 'TUDO');
 NM_tab_crit[4] = new NM_critica('NM_final');
 NM_tab_crit_1 = new NM_critica(4);
 NM_tab_crit_1[1] = new NM_critica('F1', 'old_pswd', 'Contraseña Actual', 'naomask', 'lista', 'cxab', 32, 'TUDO');
 NM_tab_crit_1[2] = new NM_critica('F1', 'pswd', 'Nueva Contraseña', 'naomask', 'lista', 'cxab', 32, 'TUDO');
 NM_tab_crit_1[3] = new NM_critica('F1', 'confirm_pswd', 'Repita Contraseña', 'naomask', 'lista', 'cxab', 32, 'TUDO');
...
{ 
   ...
   document.F4.action               = "cambiar_contrasena_fim.php";
   document.F4.submit(); 
} 
