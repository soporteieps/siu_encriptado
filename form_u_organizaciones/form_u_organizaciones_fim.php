...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIU_____form_u_organizaciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIU_____form_u_organizaciones"]);
   }
   ...
   unset($_SESSION['sc_session'][$script_case_init]['form_u_organizaciones']['sc_redir_atualiz']);
   unset($_SESSION['sc_session'][$script_case_init]['form_u_organizaciones']['sc_redir_insert']);
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_u_organizaciones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['form_u_organizaciones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_u_organizaciones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['form_u_organizaciones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['form_u_organizaciones']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['form_u_organizaciones']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['form_u_organizaciones']['db_changed'])
           {
...
<HTML>
<HEAD>
 <TITLE>form_u_organizaciones</TITLE>
