...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIU_____grid_eventos_socios"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIU_____grid_eventos_socios"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eventos_socios']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_eventos_socios']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_eventos_socios']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_eventos_socios']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_eventos_socios']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_eventos_socios</TITLE>
