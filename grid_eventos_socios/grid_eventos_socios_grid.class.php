...
//----- 
 function cabecalho()
 {
   ...
   $nm_saida->saida("    	<tr>\r\n");
   $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>" . "<b>ADMINISTRACIÓN DE SOCIOS</b>" . "</span></td>\r\n");
...
// 
 ...
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['cod_u_organizaciones'])) ? $this->New_label['cod_u_organizaciones'] : "ORGANIZACIÓN"; 
