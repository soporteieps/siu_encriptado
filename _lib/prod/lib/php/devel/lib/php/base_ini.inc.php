<?php
	...
	{
		$_SESSION['nm_session']['prod_v7']['lang'] = "en_us";
	}
	...
	$nm_config['path_lang']  		= $str_path_prod . '/devel/lang/' . str_replace("-", "_", $_SESSION['nm_session']['prod_v7']['lang']) . '/';

	include_once('../lib/php/functions.inc.php');
	include_once(dirname(dirname(dirname(dirname(__FILE__)))) . '/crypt.inc.php');
