...
class nmPage
{
     ...
     * Obs: Apenas a primeira definição de css sera reconhecida. As demais são descartadas.
     *
     * @access  protected
   ...
   function Redirect($v_str_url, $v_str_target = '', $v_str_method = 'get',
    ...
    function CheckLogin()
    {
        ...
        if (!isset($_SESSION['nm_session']['prod_v7']['logged']) || !$_SESSION['nm_session']['prod_v7']['logged'])
        {
