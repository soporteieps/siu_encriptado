...
// +----------------------------------------------------------------------+
//
// $Id: OLE_File.php,v 1.1.1.1 2011-05-12 20:31:36 diogo Exp $
...
/*                $this->_tmp_filename = tempnam($this->_tmp_dir, "OLE_PPS_File"); */
                if (isset($_SESSION['scriptcase']['dir_temp']))
                {
                    $this->_tmp_filename = tempnam($_SESSION['scriptcase']['dir_temp'], "sc_OLE_PPS_File");
                }
                else
                {
                    $this->_tmp_filename = tempnam($this->_tmp_dir, "OLE_PPS_File"); 
