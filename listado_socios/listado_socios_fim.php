...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIU_____listado_socios"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIU_____listado_socios"]);
   }
   ...
   unset($_SESSION['sc_session'][$script_case_init]['listado_socios']['sc_redir_atualiz']);
   unset($_SESSION['sc_session'][$script_case_init]['listado_socios']['sc_redir_insert']);
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['listado_socios']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['listado_socios']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['listado_socios']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['listado_socios']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['listado_socios']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['listado_socios']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['listado_socios']['db_changed'])
           {
