...
if (!isset($_SESSION['grupo_login'])) { $_SESSION['grupo_login'] = "";}
if (!isset($this->sc_temp_grupo_login)) { $this->sc_temp_grupo_login = (isset($_SESSION['grupo_login'])) ? $_SESSION['grupo_login'] : "";}
 
unset($_SESSION['scriptcase']['sc_menu_del']['menu']);if ($this->sc_temp_grupo_login == 1) { 
	
	$_SESSION['scriptcase']['sc_apl_seg']['item_16'] = "off";;
	$NM_tmp_del = 'item_16';
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . "grid_u_organizaciones/grid_u_organizaciones_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_u_organizaciones']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_u_organizaciones'] = "on";
    }
}
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . "cambiar_contrasena/cambiar_contrasena_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['cambiar_contrasena']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['cambiar_contrasena'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . "form_sec_users/form_sec_users_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_sec_users']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_sec_users'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . "form_sec_users_groups/form_sec_users_groups_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_sec_users_groups']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_sec_users_groups'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . "salir/salir_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['salir']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['salir'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
ob_end_clean();
 ...
 $nm_var_lab[0] = "Organizaciones / Unidades Económicas Populares";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[0]))
{
 ...
 $nm_var_lab[1] = "Cambio de Contraseña";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[2]))
{
 ...
 $nm_var_lab[3] = "Creación de Usuarios";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[3]))
{
 ...
 $nm_var_lab[4] = "Asignación de Perfil de Usuarios";
...
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/Mac_Black_hor.css<?php if (@is_file($this->path_css . '_menuTheme/' . Mac_Black . '_' . hor . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . Mac_Black . '_' . hor . '.css'); } ?>" />
</head>
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_u_organizaciones']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_u_organizaciones']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[0] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_32&sc_apl_menu=grid_u_organizaciones&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[0] . "",
        'id'       => "item_32",
        'icon'     => "",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['cambiar_contrasena']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['cambiar_contrasena']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[1] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_34&sc_apl_menu=cambiar_contrasena&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[1] . "",
        'id'       => "item_34",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_sec_users']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_sec_users']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[3] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_17&sc_apl_menu=form_sec_users&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[3] . "",
        'id'       => "item_17",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_sec_users_groups']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_sec_users_groups']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[4] . "",
        'level'    => "1",
        'link'     => "menu_form_php.php?sc_item_menu=item_18&sc_apl_menu=form_sec_users_groups&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[4] . "",
        'id'       => "item_18",
        'icon'     => "",
        'target'   => " target=\"" . $this->menu_target('_self') . "\"",
...
if (isset($_SESSION['scriptcase']['sc_apl_seg']['salir']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['salir']) == "on")
{
    $menu_menuData['data'][] = array(
        'label'    => "" . $nm_var_lab[5] . "",
        'level'    => "0",
        'link'     => "menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=salir&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "",
        'hint'     => "" . $nm_var_hint[5] . "",
        'id'       => "item_5",
        'icon'     => "",
...
<div style="width: 100%; height:20px;" class="scMenuHFooter">
        <span class="scMenuHFooterFont" id="rod_col1"><?php echo "Perfil: " . $_SESSION['grupo_descripcion'] . "  .-.  Usuario: " . $_SESSION['usr_login'] . "  .-.  Zona: " . $_SESSION['zona_user'] . "" ?></span>
        <span class="scMenuHFooterFont" id="rod_col2"><?php echo "" ?></span>
</div>    </td>
  </tr>
</table>
<?php
