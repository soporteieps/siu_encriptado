...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIU_____grid_u_organizaciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIU_____grid_u_organizaciones"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_u_organizaciones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_u_organizaciones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_u_organizaciones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_u_organizaciones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_u_organizaciones']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_u_organizaciones</TITLE>
