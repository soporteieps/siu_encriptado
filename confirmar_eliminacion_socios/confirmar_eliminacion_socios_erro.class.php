...
class confirmar_eliminacion_socios_erro
{
   var $Ini;
   ...
   //----- 
   function confirmar_eliminacion_socios_erro()
   {
      $this->script      = "";
      $this->linha       = "";
      $this->tipo        = "";
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe = true)
   {
      ...
      $this->monta_mensagem();
      return confirmar_eliminacion_socios_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe);
   }
