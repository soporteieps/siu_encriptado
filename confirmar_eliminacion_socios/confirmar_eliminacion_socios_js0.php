...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['confirmar_eliminacion_socios']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
</form> 
...
{
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?btn_confirmar?@?";
    document.F1.action = "confirmar_eliminacion_socios.php";
...
{ 
   ...
   document.F4.action               = "confirmar_eliminacion_socios_fim.php";
   document.F4.submit(); 
} 
