...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIU_____confirmar_eliminacion_socios"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIU_____confirmar_eliminacion_socios"]);
   }
   ...
   unset($_SESSION['sc_session'][$script_case_init]['confirmar_eliminacion_socios']['sc_redir_atualiz']);
   unset($_SESSION['sc_session'][$script_case_init]['confirmar_eliminacion_socios']['sc_redir_insert']);
   $fecha_janela = false;
   ...
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['confirmar_eliminacion_socios']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['confirmar_eliminacion_socios']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['confirmar_eliminacion_socios']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['confirmar_eliminacion_socios']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['confirmar_eliminacion_socios']['db_changed'])
           {
...
<HTML>
<HEAD>
 <TITLE>confirmar_eliminacion_socios</TITLE>
