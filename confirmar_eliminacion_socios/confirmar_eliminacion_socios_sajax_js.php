  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_confirmar_eliminacion_socios" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate txt_mensaje
  function do_ajax_confirmar_eliminacion_socios_validate_txt_mensaje()
  {
    var nomeCampo_txt_mensaje = "txt_mensaje";
    var var_txt_mensaje = scAjaxGetFieldHidden(nomeCampo_txt_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_confirmar_eliminacion_socios_validate_txt_mensaje(var_txt_mensaje, var_script_case_init, do_ajax_confirmar_eliminacion_socios_validate_txt_mensaje_cb);
  } // do_ajax_confirmar_eliminacion_socios_validate_txt_mensaje

  function do_ajax_confirmar_eliminacion_socios_validate_txt_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "txt_mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_confirmar_eliminacion_socios_validate_txt_mensaje_cb

  // ---------- Validate txt_detalles
  function do_ajax_confirmar_eliminacion_socios_validate_txt_detalles()
  {
    var nomeCampo_txt_detalles = "txt_detalles";
    var var_txt_detalles = scAjaxGetFieldHidden(nomeCampo_txt_detalles);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_confirmar_eliminacion_socios_validate_txt_detalles(var_txt_detalles, var_script_case_init, do_ajax_confirmar_eliminacion_socios_validate_txt_detalles_cb);
  } // do_ajax_confirmar_eliminacion_socios_validate_txt_detalles

  function do_ajax_confirmar_eliminacion_socios_validate_txt_detalles_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    sFieldValid = "txt_detalles";
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_confirmar_eliminacion_socios_validate_txt_detalles_cb
  // ---------- Form
  function do_ajax_confirmar_eliminacion_socios_submit_form()
  {
    scAjaxHideMessage();
    var var_txt_mensaje = scAjaxGetFieldHidden("txt_mensaje");
    var var_txt_detalles = scAjaxGetFieldHidden("txt_detalles");
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn();
    x_ajax_confirmar_eliminacion_socios_submit_form(var_txt_mensaje, var_txt_detalles, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_confirmar_eliminacion_socios_submit_form_cb);
  } // do_ajax_confirmar_eliminacion_socios_submit_form

  function do_ajax_confirmar_eliminacion_socios_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_confirmar_eliminacion_socios_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_confirmar_eliminacion_socios_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_confirmar_eliminacion_socios_navigate_form

  function do_ajax_confirmar_eliminacion_socios_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sc_mupload_ok = true;
...
{
?>
    do_ajax_confirmar_eliminacion_socios_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_confirmar_eliminacion_socios_navigate_form_cb
  ...
  ajax_field_list[0] = "txt_mensaje";
  ajax_field_list[1] = "txt_detalles";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "txt_mensaje": {"label": "MENSAJE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "txt_detalles": {"label": "DETALLES", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "txt_mensaje": new Array(),
    "txt_detalles": new Array()
  };
  ajax_field_mult["txt_mensaje"][1] = "txt_mensaje";
  ajax_field_mult["txt_detalles"][1] = "txt_detalles";

  var ajax_field_id = {
    "txt_mensaje": new Array("hidden_field_label_txt_mensaje", "hidden_field_data_txt_mensaje"),
    "txt_detalles": new Array("hidden_field_label_txt_detalles", "hidden_field_data_txt_detalles")
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("txt_mensaje" == sIndex)
    {
      scAjaxSetFieldLabel(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
    }
    if ("txt_detalles" == sIndex)
    {
      scAjaxSetFieldLabel(sIndex, aValue);
      updateHeaderFooter(sIndex, aValue);
      return;
