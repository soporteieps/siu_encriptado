...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["SIU_____reconexionWS"]))
   {
      unset($_SESSION['session_sec_aplicacao']["SIU_____reconexionWS"]);
   }
   ...
   unset($_SESSION['sc_session'][$script_case_init]['reconexionWS']['sc_redir_atualiz']);
   unset($_SESSION['sc_session'][$script_case_init]['reconexionWS']['sc_redir_insert']);
   $fecha_janela = false;
   ...
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reconexionWS']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['reconexionWS']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['reconexionWS']['sc_modal']);
           if (!isset($_SESSION['sc_session'][$script_case_init]['reconexionWS']['db_changed']) || $_SESSION['sc_session'][$script_case_init]['reconexionWS']['db_changed'])
           {
