...
<?php
include_once("reconexionWS_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('reconexionWS_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['reconexionWS']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['reconexionWS']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['reconexionWS']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['reconexionWS']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['reconexionWS']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['reconexionWS']['recarga'];
}
?>
...
<?php
 include_once("reconexionWS_js0.php");
?>
...
<?php
$int_iframe_padding = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['reconexionWS']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['reconexionWS']['run_iframe']) ? 0 : "0px";
?>
<?php
$_SESSION['scriptcase']['error_span_title']['reconexionWS'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['reconexionWS'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd" id="hidden_field_data_txt_mensaje" style="<?php echo $sStyleHidden_txt_mensaje; ?>;"> <span class="scFormLabelOddFormat" style="font-size:14px;font-weight:bold;text-align:center;vertical-align:middle;" ><span id="id_label_txt_mensaje"><?php echo $this->nm_new_label['txt_mensaje']; ?></span></span><br><span id="id_ajax_label_txt_mensaje"><?php echo $txt_mensaje?></span>
<input type=hidden name="txt_mensaje" value="<?php echo NM_encode_input($txt_mensaje); ?>">
 </TD>
   <?php }?>
...
{
?>
<script>parent.scAjaxDetailStatus("reconexionWS");</script>
<?php
}
?>
<?php
