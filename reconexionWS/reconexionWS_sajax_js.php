  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_reconexionWS" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_reconexionWS_validate_txt_mensaje()
  {
  } // do_ajax_reconexionWS_validate_txt_mensaje

  function do_ajax_reconexionWS_validate_txt_mensaje_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_reconexionWS_validate_txt_mensaje_cb
  // ---------- Form
  function do_ajax_reconexionWS_submit_form()
  {
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_reconexionWS_submit_form(var_txt_mensaje, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, do_ajax_reconexionWS_submit_form_cb);
  } // do_ajax_reconexionWS_submit_form

  function do_ajax_reconexionWS_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_reconexionWS_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_reconexionWS_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_reconexionWS_navigate_form

  function do_ajax_reconexionWS_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sc_mupload_ok = true;
...
{
?>
    do_ajax_reconexionWS_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_reconexionWS_navigate_form_cb
